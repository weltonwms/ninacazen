@extends('layouts.app')
@section('breadcrumb')
@breadcrumbs(['title'=>'Vendas', 'icon'=>'fa-cart-plus','route'=>route('vendas.index'),'subtitle'=>'Gerenciamento de Vendas'])
...
<a class="btn btn-sm btn-outline-secondary mr-1 mb-1"  href="{{route('vendas.index')}}" > <i class="fa fa-close"></i>Cancelar</a>
