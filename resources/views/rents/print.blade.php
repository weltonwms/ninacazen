...
<head>
    ...
    <title>Impressão Aluguel - {{$rent->id}}</title>
...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        <div class="box">
            ...
            <div class="column text-right">
                <div> {{$rent->id}}</div>
                <div>{{$rent->data_saida}}</div>
                <div>{{$rent->data_retorno}}</div>
            </div>
        ...
        <div id="info_cliente">
            ...
            <div class="box">
                <div class="column"><span class="label">Cliente:  </span> {{$rent->cliente->nome}}</div>
                <div class="column"><span class="label">Telefone: </span> {{$rent->cliente->telefone}}</div>

            </div>

            <div class="box">
                <div class=" column"><span class="label">Endereço:</span> {{$rent->cliente->endereco}} </div>
        ...
        <table class="" cellspacing='0' cellpadding='1'>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="destaque"><b>{{$rent->getTotalGeralFormatado()}}</b></td>
                </tr>
            </tfoot>
        </table>
        <br><br>
